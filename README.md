...
| 🖥 **Документация по GUI** | Полный гайд по веб-пульту: запуск на Ubuntu и Windows, раскладка, горячие клавиши, кастомизация, симулятор, архитектура | [`docs/GUI.md`](docs/GUI.md) • [PDF](docs/GUI.pdf) |
