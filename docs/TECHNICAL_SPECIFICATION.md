...
| **Драйверы приводов** | TB6600 (шаговики) + собственный драйвер BLDC (3-ф MOSFET) | Раздельное силовое управление на каждом колесе; драйвер BLDC — собственной разработки |
...
- **Встроенная сенсорная система мотор-колеса Xiaomi M365 Pro:**
  1. **3 цифровых датчика Холла:** используются для надежной 6-тактной аппаратной коммутации обмоток статора через собственный 3-фазный мост MOSFET;
...
3. **Собственный драйвер BLDC (3-фазный мостовой силовой инвертор на MOSFET, своя печатная плата):**
   - Покупные драйверы мотор-колеса и ESC-модули не применяются — схема и плата драйвера разработаны самостоятельно;
...
![Собственный драйвер BLDC (3-фазный MOSFET-инвертор) — визуализация платы собственной разработки](images/bldc_mosfet_driver.jpg)
