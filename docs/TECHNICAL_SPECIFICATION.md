...
| :--- | :--- | :--- |
| **Габариты платформы (Д × Ш × В)** | 920 × 680 × 560 мм | Полностью соответствует регламенту (600–1200 × 400–800 × 400–800 мм) |
| **Колесная база (L) / Колея (W)** | 660 мм / 540 мм | Оптимизировано под устойчивость при перевозке 250 кг груза |
| **Снаряженная масса платформы** | 42.0 кг | С учетом АКБ, 4 модулей и защитного металлокаркаса |
| **Номинальная грузоподъемность** | **250.0 кг** | Расчетная прочность рамы и ступиц с запасом до 350 кг |
| **Полная масса с грузом** | **292.0 кг** | Нагрузка на один модуль: ~73.0 кг (для ступиц Subaru это менее 15% от номинала) |
| **Клиренс (дорожный просвет)** | 110 мм | Беспрепятственный проезд через искусственные неровности |
| **Тип привода поворота колес** | 4 × шаговый двигатель NEMA 23 | С редуктором 1:7.5 (ремень GT2 10 мм, шкивы 20 и 150 зубьев) |
| **Тип тягового привода** | 4 × мотор-колесо самоката (BLDC) | 10 дюймов, номинальная мощность **260 Вт** на колесо |
...
### 3.1. Сварная пространственная рама под нагрузку 250 кг
...
- **Расчет несущей способности под полезную нагрузку 250 кг:**
  - При полезной нагрузке $M_{load} = 250 \text{ кг}$ и собственной массе конструкции $M_{chassis} \approx 42 \text{ кг}$ общая расчетная сила тяжести составляет:
    $$P = (250 + 42) \times 9.81 \approx 2865 \text{ Н}$$
  - Нагрузка равномерно распределяется между 4 поворотными опорами ($N \approx 716 \text{ Н} \approx 73 \text{ кг}$ на опору).
  - Момент сопротивления профиля 40×40×2 мм составляет $W \approx 3.71 \text{ см}^3$. При максимальном расчетном изгибающем моменте на продольных балках базы (длина пролета 660 мм) максимальные напряжения изгиба в металле составляют менее $42 \text{ МПа}$, что дает **более чем 5-кратный запас прочности** относительно предела текучести стали Ст3сп ($\sigma_T \approx 235 \text{ МПа}$).
  - Рама выдерживает динамические перегрузки при преодолении порожков и искусственных неровностей без остаточных деформаций.

### 3.2. Опорно-поворотный узел на автомобильных ступицах Subaru

В поворотных модулях применены **автомобильные ступичные узлы Subaru** (Subaru Forester / Impreza / Legacy).

![Ступичный узел Subaru](images/subaru_hub_bearing.jpg)

#### Инженерное обоснование выбора ступиц Subaru под нагрузку 250 кг:
1. **Колоссальный запас несущей способности:** Автомобильная ступица Subaru рассчитана на восприятие веса четверти автомобиля (до 450–500 кг статической нагрузки на колесо) и динамических ударов при попадании колеса в ямы на скорости свыше 100 км/ч (динамическая грузоподъемность $C > 38 \text{ кН}$, статическая $C_0 > 26 \text{ кН}$). Под суммарным весом робота с грузом 292 кг (всего 73 кг на ступицу) ступичный узел работает в щадящем режиме с **многократным ресурсом**.
2. **Двухрядный радиально-упорный подшипник с предварительным заводским натягом:** Полностью исключает радиальные, осевые и угловые люфты поворотного шпинделя. Это обеспечивает сохранение параллельности колес и угла поворота с точностью до $0.05^\circ$.
3. **Надежное болтовое крепление:** Фланец ступицы Subaru крепится через переходную пластину толщиной 6 мм к сварной раме 40×40 мм болтами повышенного класса прочности (10.9). На поворотную часть ступицы крепится ведомый зубчатый шкив $z_2 = 150$ зубьев и стальная вилка мотор-колеса.
...
## 5. ТЯГОВЫЙ ПРИВОД: 4 МОТОР-КОЛЕСА ПО 260 ВТ

![Мотор-колесо самоката](images/scooter_hub_motor.jpg)

### Технические параметры привода:
- 4 бесщеточных мотор-колеса от электросамоката диаметром **10 дюймов** ($D = 254 \text{ мм}$, радиус $R = 0.127 \text{ м}$);
- Номинальная мощность каждого колеса: **260 Вт**;
- Суммарная мощность 4WD шасси: $4 \times 260 = \mathbf{1040 \text{ Вт}}$ (пиковая до 1600 Вт);
- Номинальный крутящий момент мотор-колеса: $M_{mot} \approx 11.5 \text{ Н}\cdot\text{м}$ (до 15 Н·м в пике);
...
- Сила сопротивления качению робота с полной массой 292 кг по ровному асфальту ($f_{roll} = 0.02$):
  $$F_{roll} = m_{total} \cdot g \cdot f_{roll} = 292 \text{ кг} \times 9.81 \text{ м/с}^2 \times 0.02 \approx 57.3 \text{ Н}$$
...
1. **Крабовый ход (Crab / Omnidirectional):** При $\omega_z = 0$ все 4 колеса ориентируются строго под одним углом $\delta_i = \arctan(V_y / V_x)$, обеспечивая диагональное или поперечное смещение платформы без разворота корпуса.
2. **Разворот на месте (Zero-Radius Spin):** При $V_x = 0, V_y = 0$ колеса ориентируются по касательным к окружности шасси, обеспечивая поворот робота вокруг своего центра с минимальным радиусом ометания.
